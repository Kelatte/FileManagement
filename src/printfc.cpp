...
int perrorc(std::string str) { return printfc(FG_RED, str + "\n"); }
int pfilec(std::string str) { return printfc(FG_WHITE, str); }
int pdirc(std::string str) { return printfc(FG_BLACK, BG_GREEN, str); }
int ppathc(std::string str) { return printfc(FG_WHITE, str + "\n"); }
int pinfoc(std::string str) { return printfc(FG_WHITE, BG_BLUE, str + "\n"); }
int pstatc(std::string str) { return printfc(FG_YELLOW, str + "\n"); }
int psucc(std::string str) { return printfc(FG_GREEN, str + "\n"); }
